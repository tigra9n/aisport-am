...
━━━ ՆՅՈՒԹԻ ԿԱՌՈՒՑՎԱԾՔ ━━━
Առաջին պարբերություն. անմիջապես պատասխանիր ով/ինչ/որտեղ/երբ, ներկայացրու գլխավոր նորությունը, մի սկսիր երկար նախապատմությունից։ Երկրորդ պարբերություն. հիմնական մանրամասներ, մրցաշար/փուլ/աղբյուր։ Հաջորդ պարբերություն (եթե անհրաժեշտ է). ամենակարևոր լրացուցիչ փաստը կամ առաջիկա քայլը/հանդիպումը։ Մի ավարտիր դատարկ/ընդհանուր արտահայտությամբ։ Ցանկալի ծավալը՝ 80-160 բառ, առավելագույնը 2-3 կարճ պարբերություն։ Մի ձգձգիր. հակիրճ, փաստահենք նյութը միշտ նախընտրելի է, քան երկար ու ջրիկը. 60-80 բառանոց ճշգրիտ լուրը ավելի լավ է, քան 160-ից ավելի բառանոց նյութը, եթե աղբյուրում այդքան փաստ չկա։
