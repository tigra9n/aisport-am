...
Այս փաստերի հիման վրա գրիր հայերեն նյութ (120-200 բառ)՝ քո սեփական բառերով վերաշարադրված (ո՛չ ուղիղ թարգմանություն, ո՛չ մոտ-պարաֆրազ, մի մեջբերիր ամբողջական նախադասություններ բնագրից)։ ԿԱՐԵՎՈՐ. պահպանիր բնագրում հիշատակված ԲՈԼՈՐ իրական անունները՝ խաղացողներ, թիմեր, մարզիչներ, ակումբներ, մրցաշարեր, հաշիվներ/թվեր, ամսաթվեր. սրանք փաստեր են, ոչ թե բնագրի ձևակերպումը, ուստի պետք է հստակ երևան հոդվածում։ Մի գրիր ընդհանրաբանված նախադասություններ ("մի թիմ հաղթեց", "խաղացողը լավ արտահայտվեց") եթե բնագրում կոնկրետ անուն/թիվ կա։ Եթե բնագիրը բավարար փաստ չի տալիս ամբողջական հոդված գրելու համար, գրիր ավելի կարճ, բայց ճշգրիտ ամփոփում՝ դարձյալ պահպանելով առկա անունները։ category դաշտում գրիր ամենահարմար մարզաձևի անունը (Ֆուտբոլ, Բասկետբոլ, Թենիս, և այլն)։`;
  const { text, debug } = await callClaude(SYSTEM_PROMPT, userPrompt, apiKey);
  lastGenerationDebug = debug;
  if (!text) return null;
