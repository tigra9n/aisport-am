...
- Հայաստանի ազգային առաջնության ճիշտ անունն է «Հայաստանի Պրեմիեր լիգա»։
- Տուգանային գոտին՝ «տուգանային հրապարակ»։ Պատժական հարվածը՝ «11 մետրանոց հարված»։ Ուղիղ հեռացումը՝ «ուղիղ կարմիր քարտ»։ Խաղից հեռացվելը՝ «հեռացվել է խաղադաշտից»։
- Գոլին նախորդող որոշիչ փոխանցումը՝ «գոլային փոխանցում» (assist) — սա ՄԻԱԿ ճիշտ դեպքն է, երբ «փոխանցում» բառը թույլատրելի է, քանի որ միշտ «գոլային»-ով է ճշգրտված. մենակ «փոխանցում» (առանց «գոլային»-ի) երբեք մի օգտագործիր տրանսֆերի իմաստով։
- Առաջնության դիրքացուցակը՝ «մրցաշարային աղյուսակ» կամ պարզապես «աղյուսակ»։
- Վնասվածք ստանալը՝ «վնասվածք ստացել/ստանալ», վերականգնման ժամկետը՝ «ապաքինման ժամկետ»։ Կոնկրետ վնասվածքի տեսակի համար օգտագործիր ճշգրիտ բառ, եթե հայտնի է (օր. «կոտրվածք» ոսկրի կոտրվածքի համար)։
- Խաղից առաջ ստորագրված նախնական համաձայնությունը (դեռ պաշտոնական տրանսֆերից առաջ)՝ «նախնական պայմանագիր»։
- Խաղից առաջ մարզիչի հետ հանդիպումը լրագրողների հետ՝ «նախախաղային ասուլիս»։
- Ֆուտբոլիստի ընթացիկ պատրաստվածությունը՝ «մարզավիճակ» (ոչ «ֆորմա», որ հագուստի իմաստ ունի հայերենում)։
- Մրցաշարից/խաղերից ժամանակավոր հեռացումը՝ «որակազրկում» (disqualification/suspension)։
- Երկգնդակ (home+away) փուլի երկրորդ խաղը՝ «պատասխան հանդիպում», առաջինը՝ «առաջին հանդիպում»։ Ընտրական/նախնական փուլը՝ «անցումային փլեյ-օֆֆ փուլ»։ Մրցավարական խմբի ամբողջությունը՝ «մրցավարական անձնակազմ»։
- Անկյունից կատարվող հարվածը՝ «անկյունային հարված»։ Ցանցի/դարպասի համար օգտագործիր «դարպաս» (ոչ բառացի «gate»)։
- Ընթացիկ տիտղոսակիրը՝ «գործող չեմպիոն»։
- Չեմպիոնների/Եվրոպա/Կոնֆերենցիաների լիգայի նոր ֆորմատի խմբային փուլը (36 թիմանոց)՝ «լիգայի փուլ», ոչ «խմբային փուլ» (այդ ձևաչափը փոխարինել է հին խմբերի համակարգին)։
- Կրկին նշանակված տուգանային հարվածը՝ «կրկնված 11-մետրանոց»։

Բնական ձևակերպումներ/արտահայտություններ (ոչ միայն single բառեր).
- Աղյուսակում առաջատարությունը՝ «գլխավորում է աղյուսակը/ցուցակը» (օր. «Ցուցակը գլխավորում է Իսպանիայի հավաքականը»)։
- Աղյուսակում կոնկրետ դիրքը՝ Հայկական լրագրության մեջ ընդունված է «Х-րդ հորիզոնականում» ձևակերպումը (օր. «Երկրորդ հորիզոնականում աշխարհի գործող չեմպիոնն է»), ոչ պարզապես «Х-րդ տեղում»։
- Ֆավորիտների/լավագույնների ցուցակը՝ «վարկանիշային աղյուսակ», ոչ «ռեյտինգային աղյուսակ»։
- Մրցաշրջանի լավագույն խաղացողներից կազմված պայմանական թիմը՝ «խորհրդանշական հավաքական» (Team of the Season)։
- Դժվար փուլից հաղթահարելով անցնելը՝ «[փուլի անվանում]-ի արգելքը հաղթահարել» (օր. «1/8 եզրափակիչի արգելքը հաղթահարել»)։
- Տիտղոս/ուղեգիր/հաղթանակ ձեռք բերելը՝ նախընտրելի է «նվաճել» (ոչ պարզապես «ստանալ» կամ «ունենալ»)։
- Մեկ խաղում 2 գոլ խփելը՝ «դուբլ ձևակերպել» (ՄԻ՛ ԳՐԻՐ «կրկնագոլ», այդ բառը չի օգտագործվում)։ 3 գոլը՝ «հեթ-թրիք»։
