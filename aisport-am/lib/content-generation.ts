...
// A second overcorrection, found the same way as the first. Tigran asked
// why the articles never carry a direct quote, and the prompt turned out
// to forbid quotes in four places - "never invent a quote", "copying long
// quotes is forbidden", "do not quote whole sentences from the original",
// and, here, "do not add quotes that are not in the source" - against a
// single permission buried mid-sentence inside one of those prohibitions.
// A cautious model at temperature 0.3 reads that list and simply stops
// writing quotes at all, which costs the best thing a football story has.
// Each of the four now says explicitly that the ban is on inventing and on
// wholesale copying, not on quoting, and that dropping a quote the source
// really carries is as wrong as inventing one.
const GEMINI_PROMPT_SUFFIX = `

━━━ ԼՐԱՑՈՒՑԻՉ ԽՍՏՈՒԹՅՈՒՆ ━━━
Գրիր ԲԱՑԱՌԱՊԵՍ քեզ տրված աղբյուր-նյութի փաստերի հիման վրա։ Մի ավելացրու քո հիշողությունից եկած մանրամասներ (փոխանցման գումարներ, պայմանագրի ժամկետներ, հաշիվներ, ամսաթվեր, մեջբերումներ), որոնք աղբյուրում չկան։ Բայց աղբյուրում ԵՂԱԾ ուղիղ խոսքը միշտ բեր՝ խոսողի անունով և չակերտների մեջ. արգելքը հորինելու մասին է, ոչ թե օգտագործելու։ Եթե աղբյուրի փաստերը քիչ են ամբողջական հոդվածի համար, գրիր ավելի կարճ նյութ, բայց ոչինչ մի լրացրու։
...
Արգելվում է. պատճենել աղբյուրի վերնագիրը, պատճենել ամբողջական նախադասություններ, պահպանել աղբյուրի պարբերությունների նույն հերթականությունը, պարզապես մի քանի բառ փոխարինել հոմանիշներով, երկար մեջբերումներ արտագրել։ Առանձնացրու փաստերը, որոշիր գլխավոր նորությունը, ընտրիր նոր կառուցվածք, գրիր զրոյից։
ՈՒՂԻՂ ԽՈՍՔԸ ՊԱՐՏԱԴԻՐ Է, ԵՐԲ ԱՂԲՅՈՒՐՈՒՄ ԿԱ։ Եթե աղբյուր-նյութում մարզչի, ֆուտբոլիստի, ակումբի ղեկավարի կամ պաշտոնյայի ուղիղ խոսք կա, ԱՆՊԱՅՄԱՆ բեր այն նյութի մեջ՝ մեկ-երկու նախադասություն, ճշգրիտ թարգմանված, խոսողի անունով և չակերտների մեջ։ Օրինակ. Արտետան նշել է. «Մենք գիտեինք, որ երկրորդ խաղակեսը դժվար կլինի»։ Վերևի արգելքը ՀՈՐԻՆԵԼՈՒ ու ԵՐԿԱՐ ԱՐՏԱԳՐԵԼՈՒ մասին է, ոչ թե բերելու. աղբյուրում եղած մեջբերումը բաց թողնելը նույնքան սխալ է, որքան չեղածը հորինելը։ Մեջբերումը թարգմանիր ճշգրիտ, հրապարակիր միայն անհրաժեշտ հատվածը, իմաստը մի փոխիր։
...
Այս փաստերի հիման վրա գրիր ծանրակշիռ, բովանդակային հայերեն նյութ (250-400 բառ)՝ քո սեփական բառերով վերաշարադրված (ո՛չ ուղիղ թարգմանություն, ո՛չ մոտ-պարաֆրազ, մի արտագրիր բնագրի ամբողջական նախադասությունները որպես քո տեքստ)։ Սա չի վերաբերում ուղիղ խոսքին. եթե աղբյուրում որևէ մեկի մեջբերում կա, բեր այն չակերտների մեջ, խոսողի անունով։
