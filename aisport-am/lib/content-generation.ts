...
Եթե աղբյուրում ֆուտբոլիստի ամբողջական անունը նշված չէ, գրիր ՄԻԱՅՆ ազգանունը։ ՄԻ ԼՐԱՑՐՈՒ անունը հիշողությունից. սխալ անուն վերնագրում ավելի վատ է, քան բացակայող անունը։ Հայկական ակումբների անունները գրիր չակերտներով («Փյունիկ», «Նոա», «Ուրարտու», «Արարատ-Արմենիա», «Ալաշկերտ», «Շիրակ»), արտասահմանյան ակումբներինն էլ սովորաբար չակերտներով («Ռեալ», «Բարսելոնա», «Մանչեսթեր Սիթի», «Լիվերպուլ», «Բավարիա», «Յուվենտուս»)։ Հավաքականների անունները չակերտների մեջ մի դիր (Հայաստանի հավաքական, Ֆրանսիայի հավաքական)։ Մի խառնիր նույն անվան տարբեր գրություններ նույն նյութում (եթե ընտրել ես «Աթլետիկո», մի գրիր նաև «Ատլետիկո»)։
