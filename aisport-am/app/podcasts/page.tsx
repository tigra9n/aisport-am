...
const episodes: PodcastEpisode[] = [
  { id: "today", date: "Այսօր · 21 օգոստոսի", title: "Օրվա խաղերը և ամենակարևոր մարզական թեմաները", summary: "AISport-ի 10-րոպեանոց արագ ամփոփումը՝ գլխավոր լուրը, կարևոր թվերն ու առաջիկա խաղերը մեկ թողարկման մեջ։", duration: "10:00" },
